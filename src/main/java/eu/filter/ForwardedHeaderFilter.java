...
public class ForwardedHeaderFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		filterChain.doFilter(new ForwardedHeaderRequestWrapper(request, this.pathHelper),
				new ForwardedHeaderResponseWrapper(response, request));
	}
	...
	private static class ForwardedHeaderResponseWrapper extends HttpServletResponseWrapper {
		...
		public void sendRedirect(String location) throws IOException {
			...
			UriComponents uriComponents = UriComponentsBuilder.fromHttpRequest(httpRequest).replacePath(location)
					.build();
